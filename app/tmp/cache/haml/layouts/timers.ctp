...
if (substr_count($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip')){
  ...
  echo '<link href="https://s3.amazonaws.com/homkora-static/css/jquery.stopwatch.gz.css" type="text/css" rel="stylesheet">';
}else{
  echo '<link href="https://s3.amazonaws.com/homkora-static/css/homkora-static.css" type="text/css" rel="stylesheet">';
  echo '<link href="https://s3.amazonaws.com/homkora-static/css/jquery.stopwatch.css" type="text/css" rel="stylesheet">';
}
?>
...
if (substr_count($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip')){
  echo '<script type="text/javascript" src="https://s3.amazonaws.com/homkora-static/js/jquery.stopwatch.gz.js"></script>';
  echo '<script type="text/javascript" src="https://s3.amazonaws.com/homkora-static/js/checkform.gz.js"></script>';
  echo '<script type="text/javascript" src="https://s3.amazonaws.com/homkora-static/js/createTimer.gz.js"></script>';
  echo '<script type="text/javascript" src="https://s3.amazonaws.com/homkora-static/js/common.gz.js"></script>';
}else{
  echo '<script type="text/javascript" src="https://s3.amazonaws.com/homkora-static/js/jquery.stopwatch.js"></script>';
  echo '<script type="text/javascript" src="https://s3.amazonaws.com/homkora-static/js/checkform.js"></script>';
  echo '<script type="text/javascript" src="https://s3.amazonaws.com/homkora-static/js/createTimer.js"></script>';
