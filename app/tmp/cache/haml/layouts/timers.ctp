...
if (substr_count($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip')){
  echo '<script type="text/javascript" src="http://static.homkora.com/js/jquery.stopwatch.gz.js"></script>';
  echo '<script type="text/javascript" src="http://static.homkora.com/js/checkform.gz.js"></script>';
  echo '<script type="text/javascript" src="http://static.homkora.com/js/createTimer.gz.js"></script>';
  echo '<script type="text/javascript" src="http://static.homkora.com/js/common.gz.js"></script>';
}else{
  echo '<script type="text/javascript" src="http://static.homkora.com/js/jquery.stopwatch.js"></script>';
  echo '<script type="text/javascript" src="http://static.homkora.com/js/checkform.js"></script>';
  echo '<script type="text/javascript" src="http://static.homkora.com/js/createTimer.js"></script>';
