...
?><!DOCTYPE html>
<html><head><meta charset="utf-8" /><title>Time Tracking Made Simple | Homkora</title><?php echo $html->css('scss-style');; ?></head><body><header><h1> <a href="http://homkora.com">Homkora</a> </h1><nav><?php
