...
<div class="bottomLinks">
	...
	<?php echo $this->Html->link(__($html->image('icon_pencil.png', array('alt' => 'Edit','title'=>'Edit')).'Edit Timer', true), array('action' => 'edit', $timer['Timer']['id']),array('escape' => false,'class'=>'button addTimerIndex')); ?>
	<?php echo $this->Html->link(__($html->image('icon_delete.png', array('alt' => 'Delete','title'=>'Delete')).'Delete Timer', true), array('action' => 'delete', $timer['Timer']['id']),array('escape' => false,'class'=>'button addTimerIndex'), sprintf(__('Are you sure you want to delete # %s?', true), $timer['Timer']['id'])); ?> </li>
